...
everything is fine the line is a model name, the five-hour quota with its reset
time and the context percentage (both always visible: they are your margin). The full
